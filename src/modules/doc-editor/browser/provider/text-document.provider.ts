...
import { DocumentEditorServiceToken } from '../../common';
...
@Injectable()
export class TextEditorDocumentContentProvider implements IEditorDocumentModelContentProvider {
  ...
  handlesScheme?(scheme: string): MaybePromise<boolean> {
    return scheme === 'text-view-scheme';
  }
